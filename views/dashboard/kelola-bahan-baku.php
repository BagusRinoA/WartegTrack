        ...
        <div class="dashboard-header">
            <div class="header-left">
                <div class="title-section">
                    ...
                    <div>
                        <h1 class="main-title">KELOLA BAHAN BAKU</h1>
...
<div id="addBahanModal" class="modal" style="display:none;">
    <div class="modal-content">
        <div class="modal-header"><h2>Tambah Bahan Baku</h2><span class="close-btn" onclick="closeAddBahanForm()">&times;</span></div>
        <form method="post" action="index.php?page=kelola-bahan-baku" class="menu-form">
...
<div id="editBahanModal" class="modal" style="display:none;">
    <div class="modal-content">
        <div class="modal-header"><h2>Edit Bahan Baku</h2><span class="close-btn" onclick="closeEditBahanForm()">&times;</span></div>
        <form method="post" action="index.php?page=kelola-bahan-baku" class="menu-form">
            ...
            <div class="form-row">
                <div class="form-group"><label>Unit Satuan</label>
                    <select name="unit_satuan" id="edit_bahan_unit">
                        <option>Kg</option><option>Ikat</option><option>Pcs</option><option>Liter</option><option>Gram</option>
                    </select>
                </div>
...
function deleteBahan(id){ if(!confirm('Hapus bahan baku ini?')) return; const f=document.createElement('form'); f.method='POST'; f.action='index.php?page=kelola-bahan-baku'; f.innerHTML=`<input type="hidden" name="action" value="delete"><input type="hidden" name="id" value="${id}">`; document.body.appendChild(f); f.submit(); }
