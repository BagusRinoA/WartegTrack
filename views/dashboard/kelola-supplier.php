<div class="dashboard-wrapper">
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="index.php?page=kelola-supplier" class="active">
        ...
        <div class="dashboard-header">
            <div class="header-left">
                <div class="title-section">
                    ...
                    <div>
                        <h1 class="main-title">KELOLA SUPPLIER</h1>
                            ...
                            <?php if (!empty($suppliers)): ?>
                                ...
                                <?php foreach ($suppliers as $s): ?>
                                    <tr data-id="<?= $s['id'] ?>" data-nama="<?= htmlspecialchars($s['nama']) ?>" data-kontak="<?= htmlspecialchars($s['kontak'] ?? '') ?>" data-alamat="<?= htmlspecialchars($s['alamat'] ?? '') ?>" data-catatan="<?= htmlspecialchars($s['catatan'] ?? '') ?>">
                                        ...
                                        <td><?= htmlspecialchars(substr($s['catatan'] ?? '-',0,40)) ?>...</td>
                                        <td>
...
<div id="addSupplierModal" class="modal" style="display:none;">
    <div class="modal-content">
        ...
        <form method="post" action="index.php?page=kelola-supplier" class="menu-form">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn-cancel" onclick="closeAddSupplierForm()">Batal</button>
            </div>
        </form>
    </div>
</div>
...
<div id="editSupplierModal" class="modal" style="display:none;">
    <div class="modal-content">
        ...
        <form method="post" action="index.php?page=kelola-supplier" class="menu-form">
            ...
            <div class="form-group">
                <label>Nama Supplier</label>
                <input type="text" name="nama" id="edit_supplier_nama" required>
            </div>
            <div class="form-group">
                <label>Kontak</label>
                <input type="text" name="kontak" id="edit_supplier_kontak">
            </div>
            <div class="form-group">
                <label>Alamat</label>
                <textarea name="alamat" id="edit_supplier_alamat" rows="3"></textarea>
            </div>
            <div class="form-group">
                <label>Catatan</label>
                <textarea name="catatan" id="edit_supplier_catatan" rows="3"></textarea>
            </div>
            <div class="form-actions">
                <button type="submit" class="btn-save">Update</button>
                <button type="button" class="btn-cancel" onclick="closeEditSupplierForm()">Batal</button>
            </div>
        </form>
    </div>
</div>
...
function deleteSupplier(id){
    ...
    const f = document.createElement('form'); f.method='POST'; f.action='index.php?page=kelola-supplier';
